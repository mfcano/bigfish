...
const Footer = () => {
  ...
  return (
    <footer
      className={`border-t py-6 mt-12 ${getFooterClass()}`}
    >
      <div className={`container mx-auto px-4 text-center text-sm ${getSubTextClass()}`}>
        <p>
          {currentTheme === 'rms'
        ...
        {currentTheme === 'rms' && (
          <div className="mt-2 text-[10px]">
            [ <a href="#" className="text-[#006699] underline">Admin CP</a> ] [
            <a href="#" className="text-[#006699] underline"> Mod CP</a> ]
          </div>
        )}
      </div>
    </footer>
